...
import android.app.hlqserver.HlqServerManager;
...
public class PackageInstallerActivity extends OverlayTouchActivity implements OnClickListener {
    ...
    private static final int REQUEST_HLQ_NEW_PERMISSION = 2; // hlq
    ...
    public void onActivityResult(int request, int result, Intent data) {
        ...
        // hlq bgn
        if (request == REQUEST_HLQ_NEW_PERMISSION) {
            startInstall();
            return;
        }
        // hlq end
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (icicle != null) {
            ...
            // hlq bgn
            newPermissionChecked = icicle.getBoolean("hlq_checked");
            // hlq end
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // hlq bgn
        outState.putBoolean("hlq_checked", newPermissionChecked);
        // hlq end
    }
    ...
    private boolean newPermissionChecked = false; // hlq

    private void startInstall() {

        // hlq begin
        if (!newPermissionChecked) {
            newPermissionChecked = true;
            try {
                Intent mIntent = new Intent();
                mIntent.putExtra("pkg_name",
                        mPkgInfo.applicationInfo.packageName);
                mIntent.setClass(this, FmcNewPermissionActivity.class);
                startActivityForResult(mIntent,
                        REQUEST_HLQ_NEW_PERMISSION);
                return;
