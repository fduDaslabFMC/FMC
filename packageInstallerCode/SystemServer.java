...
import com.android.server.hlqserver.HlqServer;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
        ...
        // hlq added
        try {
            ServiceManager.addService(HlqServer.TOKEN, new HlqServer(context));
        } catch (Throwable e) {
            Slog.e(TAG, "Failure starting " + HlqServer.TOKEN);
        }
        // hlq added
    }
