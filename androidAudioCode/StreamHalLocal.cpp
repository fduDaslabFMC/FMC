...
#define myTAG "StreamHalLocal_Chen"
...
status_t StreamInHalLocal::setAudioControlConfiguration(String8 audioControlConfiguration){
    LOGD("StreamInHalLocal--------set params,%s，do nothing",audioControlConfiguration.string());
    return OK;
}
